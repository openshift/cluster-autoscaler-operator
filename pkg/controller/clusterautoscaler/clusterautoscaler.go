...
func AutoscalerArgs(ca *v1beta1.ClusterAutoscaler, cfg *Config) []string {
	s := &ca.Spec
...
func ScaleDownArgs(sd *v1beta1.ScaleDownConfig) []string {
	if !sd.Enabled {
...
func ResourceArgs(rl *v1beta1.ResourceLimits) []string {
	args := []string{}
